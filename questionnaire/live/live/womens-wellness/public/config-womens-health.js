...
const questionnaireConfig = {
  ...
  femaleGeneralTimeline: {
    '<25': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Cycle begins to respond', hiDesc: 'चक्र प्रतिक्रिया देना शुरू करता है' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'Periods become more predictable', hiDesc: 'मासिक धर्म अधिक अनुमानित हो जाता है' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Regular cycles (within 3–5 days)', hiDesc: 'नियमित चक्र (3–5 दिनों के भीतर)' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'Smooth and timely cycles', hiDesc: 'सुचारू और समय पर चक्र' },
    ],
    '25-60': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Mild improvement in cycle timing', hiDesc: 'चक्र समय में हल्का सुधार' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'Cycles more predictable', hiDesc: 'चक्र अधिक अनुमानित' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Periods regular and lighter', hiDesc: 'मासिक धर्म नियमित और हल्का' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'Healthy cycle pattern maintained', hiDesc: 'स्वस्थ चक्र पैटर्न बना रहता है' },
    ],
    '61-80': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Slight improvement in timing', hiDesc: 'समय में हल्का सुधार' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'Regular and balanced cycles', hiDesc: 'नियमित और संतुलित चक्र' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Fully predictable periods', hiDesc: 'पूरी तरह अनुमानित मासिक धर्म' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'Cycles easy and on time', hiDesc: 'चक्र आसान और समय पर' },
    ],
    '81+': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Cycles stay smooth and regular', hiDesc: 'चक्र सुचारू और नियमित रहते हैं' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'Healthy rhythm continues', hiDesc: 'स्वस्थ लय जारी रहती है' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Consistent and healthy periods', hiDesc: 'सुसंगत और स्वस्थ मासिक धर्म' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'Long-term menstrual wellness', hiDesc: 'दीर्घकालिक मासिक कल्याण' },
    ],
  },
  hormonalTimelineByScore: {
    '<25': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Slight improvement in Acne, mood, and bloating', hiDesc: 'मुंहासे, मनोदशा और सूजन में हल्का सुधार' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'Slow growth of facial hair, better skin', hiDesc: 'चेहरे के बालों की धीमी वृद्धि, बेहतर त्वचा' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Skin clears, improvement in mood, weight shifts', hiDesc: 'त्वचा साफ होती है, मनोदशा में सुधार, वज़न में बदलाव' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'Balanced hormones, stable weight and energy', hiDesc: 'संतुलित हार्मोन, स्थिर वज़न और ऊर्जा' },
    ],
    '25-60': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Mood steadier, acne reduces', hiDesc: 'मनोदशा अधिक स्थिर, मुंहासे कम होते हैं' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'Facial hair slows, emotional stability', hiDesc: 'चेहरे के बालों की वृद्धि धीमी, भावनात्मक स्थिरता' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Skin texture better, weight balanced', hiDesc: 'त्वचा की बनावट बेहतर, वज़न संतुलित' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'No mood swings, better skin and stamina', hiDesc: 'मूड स्विंग्स नहीं, बेहतर त्वचा और स्टैमिना' },
    ],
    '61-80': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Mild bloating or acne relief', hiDesc: 'हल्की सूजन या मुंहासों में राहत' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'Mood and hair improve', hiDesc: 'मनोदशा और बालों में सुधार' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Hormones steady, body feels lighter', hiDesc: 'हार्मोन स्थिर, शरीर हल्का महसूस होता है' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'Balanced energy and skin', hiDesc: 'संतुलित ऊर्जा और त्वचा' },
    ],
    '81+': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Stable mood and acne', hiDesc: 'स्थिर मनोदशा और मुंहासे' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'High energy, clear skin', hiDesc: 'उच्च ऊर्जा, साफ त्वचा' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Hormones stay balanced', hiDesc: 'हार्मोन संतुलित रहते हैं' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'Full hormonal harmony', hiDesc: 'पूर्ण हार्मोनल सामंजस्य' },
    ],
  },
  pmsTimelineByScore: {
    '<25': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Cramp relief begins, energy rises', hiDesc: 'दर्द में राहत शुरू, ऊर्जा बढ़ती है' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'PMS and heaviness reduce', hiDesc: 'PMS और भारीपन कम होता है' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Mild Cramps, periods more comfortable', hiDesc: 'हल्के दर्द, मासिक धर्म अधिक आरामदायक' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'PMS barely noticeable', hiDesc: 'PMS मुश्किल से महसूस होता है' },
    ],
    '25-60': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Pain and bloating ease', hiDesc: 'दर्द और सूजन में राहत' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'PMS improves', hiDesc: 'PMS में सुधार' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Rare cramps, better focus', hiDesc: 'दुर्लभ दर्द, बेहतर एकाग्रता' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'PMS gone or minimal', hiDesc: 'PMS समाप्त या न्यूनतम' },
    ],
    '61-80': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Lighter periods, less discomfort', hiDesc: 'हल्के मासिक धर्म, कम असुविधा' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'Very mild PMS', hiDesc: 'बहुत हल्का PMS' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Pain-free periods', hiDesc: 'दर्द रहित मासिक धर्म' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'PMS-free cycles', hiDesc: 'PMS मुक्त चक्र' },
    ],
    '81+': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'No bloating or pain', hiDesc: 'कोई सूजन या दर्द नहीं' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'Zero PMS signs', hiDesc: 'PMS के कोई लक्षण नहीं' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Sustained relief', hiDesc: 'निरंतर राहत' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'PMS-free and active life', hiDesc: 'PMS मुक्त और सक्रिय जीवन' },
    ],
  },
  vaginalHealthTimelineByScore: {
    '<25': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Itching and discharge reduce', hiDesc: 'खुजली और स्राव कम होता है' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'Discharge and odor improve', hiDesc: 'स्राव और गंध में सुधार' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Vaginal comfort improves further', hiDesc: 'योनि की सहजता और बेहतर होती है' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'Long-term freshness and balance', hiDesc: 'दीर्घकालिक ताज़गी और संतुलन' },
    ],
    '25-60': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Discharge and irritation reduce', hiDesc: 'स्राव और जलन कम होती है' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'Odor fades, pH improves', hiDesc: 'गंध कम होती है, pH बेहतर होता है' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'No abnormal discharge', hiDesc: 'कोई असामान्य स्राव नहीं' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'Consistent freshness and balance', hiDesc: 'सुसंगत ताज़गी और संतुलन' },
    ],
    '61-80': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Occasional itching improves', hiDesc: 'कभी-कभार होने वाली खुजली में सुधार' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'No odor or discomfort', hiDesc: 'कोई गंध या असुविधा नहीं' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Clean and balanced hygiene', hiDesc: 'स्वच्छ और संतुलित स्वच्छता' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'pH maintained, no discharge issues', hiDesc: 'pH बना रहता है, कोई स्राव समस्या नहीं' },
    ],
    '81+': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Clean, fresh, and balanced', hiDesc: 'स्वच्छ, ताज़ा और संतुलित' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'No complaints', hiDesc: 'कोई शिकायत नहीं' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Hygiene feels natural', hiDesc: 'स्वच्छता स्वाभाविक लगती है' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'Intimate health optimal', hiDesc: 'निजी स्वास्थ्य आदर्श' },
    ],
  },
  estrogenPCOSTimelineByScore: {
    '<25': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Bloating and soreness lessen', hiDesc: 'सूजन और दर्द कम होता है' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'Ovulation symptoms reappear', hiDesc: 'ओव्यूलेशन के लक्षण फिर से दिखते हैं' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Ovulation becomes regular', hiDesc: 'ओव्यूलेशन नियमित होता है' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'Improved symptoms of PCOS ', hiDesc: 'PCOS के लक्षणों में सुधार' },
    ],
    '25-60': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Hormonal swelling reduces', hiDesc: 'हार्मोनल सूजन कम होती है' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'Better mid-cycle flow', hiDesc: 'बेहतर मध्य-चक्र प्रवाह' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Hormone profile improves', hiDesc: 'हार्मोन प्रोफ़ाइल में सुधार' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'PCOS signs well-managed', hiDesc: 'PCOS के संकेत अच्छी तरह प्रबंधित' },
    ],
    '61-80': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Estrogen balance starts', hiDesc: 'एस्ट्रोजन संतुलन शुरू होता है' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'Ovulation clearer', hiDesc: 'ओव्यूलेशन स्पष्ट' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Hormones self-regulate', hiDesc: 'हार्मोन स्वतः नियंत्रित होते हैं' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'Stable and symptom-free', hiDesc: 'स्थिर और लक्षण मुक्त' },
    ],
    '81+': [
      { month: 'Month 1', hi: 'महीना 1', timelineDesc: 'Estrogen under control', hiDesc: 'एस्ट्रोजन नियंत्रण में' },
      { month: 'Month 2', hi: 'महीना 2', timelineDesc: 'Balanced cycle maintained', hiDesc: 'संतुलित चक्र बना रहता है' },
      { month: 'Month 3', hi: 'महीना 3', timelineDesc: 'Hormonal rhythm stable', hiDesc: 'हार्मोनल लय स्थिर' },
      { month: 'Month 6', hi: 'महीना 6', timelineDesc: 'No PCOS risk or relapse', hiDesc: 'PCOS का कोई खतरा या पुनरावृत्ति नहीं' },
    ],
  },
