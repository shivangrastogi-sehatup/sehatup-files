...
const questionnaireConfig = {
    uiStrings: {
        en: {
            ...
            "step-3-title": "Enter your body measurements for personalized health metrics.",
            "category": "Women's Weight Management",
        ...
        hi: {
            ...
            "welcome-title": "महिला वज़न और मेटाबॉलिज़्म प्रश्नोत्तरी में आपका स्वागत है!",
            "step-3-title": "व्यक्तिगत स्वास्थ्य आंकड़ों के लिए अपने शरीर की माप दर्ज करें।",
            "category": "महिला वज़न प्रबंधन",
            "label-height": "लंबाई (सेमी में):",
    ...
    saveSubmission: async (state, db, config) => {
        ...
        const data = {
            ...
            futureRisks: (results.futureRisks || []).map(text => ({ text })),
